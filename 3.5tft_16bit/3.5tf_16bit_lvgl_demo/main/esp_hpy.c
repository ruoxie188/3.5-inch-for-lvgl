...
esp_lcd_panel_io_handle_t g_io_handle = NULL; // <-- 【新增】定义全局 IO 句柄
esp_lcd_touch_handle_t g_tp_handle = NULL;

esp_err_t bsp_display_init(void)
{
    ESP_LOGI(TAG, "Initializing 16-bit parallel display...");
    ...
    esp_lcd_i80_bus_config_t bus_config = {
        ...
        .bus_width = 16,
        .max_transfer_bytes = LCD_H_RES * LCD_DRAW_BUF_HEIGHT * sizeof(uint16_t),
    ...
    esp_lcd_panel_io_i80_config_t io_config = {
        ...
        .flags.swap_color_bytes = false, // 16位模式下通常不需要交换颜色字节
    ...
    // 【关键】将屏幕旋转和镜像操作交由 LVGL Port 组件管理，以确保触摸和显示同步
