...
#include <byteswap.h> // For __bswap_16 on some toolchains
#ifndef __bswap_16
#define __bswap_16(x) __builtin_bswap16(x) // GCC/Clang intrinsic
#endif
...
esp_err_t bsp_display_init(void)
{
    ...
    spi_bus_config_t buscfg = {
        ...
        // --- FIX 1: Corrected typo from PIN_NM_MOSI to PIN_NUM_MOSI ---
    ...
    esp_lcd_panel_io_spi_config_t io_config = {
        ...
        .lcd_cmd_bits = 8,
        .lcd_param_bits = 8,
        // --- FIX 2: Removed .swap_color_bytes as it's not supported in your IDF version ---
        // The byte swapping will now be handled in software in bsp_fill_screen()
    };
...
void bsp_fill_screen(uint16_t color)
{
    ...
    // --- FIX 2 (Continuation): Manually swap color bytes in software ---
    // This compensates for the lack of hardware `swap_color_bytes` feature.
